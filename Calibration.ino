...
void setup() {
  ...
  lcd.setCursor(0, 0); // Posisikan kursor di baris 1, kolom 1
  lcd.print("Hello");  // Tampilkan teks pada layar LCD
  lcd.setCursor(0, 1); // Posisikan kursor di baris 2, kolom 1
  lcd.print("World");
